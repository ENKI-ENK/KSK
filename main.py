...
def setup_dependencies(beta_mode=False):
    ...
    if not os.path.exists("requirements.txt"):
        ...
        if not download_requirements_from_release(beta_mode=beta_mode):
            ...
            print("• Please download the complete bot package from: https://github.com/ENKI-ENK/KSK/releases")
            return False
    ...
    async def main():
        ...
        while True:
            try:
                ...
                print(f"{F.YELLOW}https://github.com/ENKI-ENK/KSK/wiki/Creating-a-Discord-Application{R}")
                break
